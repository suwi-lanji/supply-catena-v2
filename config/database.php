    ...
    */
    ...
    'connections' => [
        ...
        'mysql' => [
            ...
            'port' => env('DB_PORT', '8093'),
            'database' => env('DB_DATABASE', 'warehouse'),
            'username' => env('DB_USERNAME', 'twalitso'),
        ...
        'pgsql' => [
            'driver' => 'pgsql',
            'url' => env('DB_URL'),
            'host' => env('DB_HOST', '209.97.129.148'),
            'port' => env('DB_PORT', '5433'),
            'database' => env('DB_DATABASE', 'warehouse_dev'),
            'username' => env('DB_USERNAME', 'suwilanji'),
            'password' => env('DB_PASSWORD', 'lordcaesar'),
