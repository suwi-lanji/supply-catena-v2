...
<?php $component->withAttributes([]); ?>
    ...
    <?php echo e(date('Y/m/d', strtotime($sales_order->sales_order_date))); ?> - 
    <?php echo e($sales_order->expected_shippment_date != null ? date('Y/m/d', strtotime($sales_order->expected_shippment_date)) : ''); ?>
...
<div class="flex justify-between items-end">
    <table class="table-auto border-collapse border border-gray-300 h-fit">
        ...
        <tbody>
            <tr>
                <td class="text-center"><?php echo e($record->sales_order_number); ?></td>
            </tr>
        </tbody>
    </table>
    <table class="table-auto w-1/2 text-right border-collapse border border-gray-300">
        <tbody class="divide-y">
            <tr class="text-left">
                ...
                <td class="text-right"><?php echo e(number_format($sub_total, 2)); ?></td>
            </tr>
            <tr class="text-left">
                <td class="bg-gray-100 dark:bg-gray-500 text-center">VAT @ <?php echo e($vat); ?>%</td>
                <td class="text-right"><?php echo e(number_format($sub_total * ($vat/100), 2)); ?></td>
            </tr>
            <tr class="text-left">
                <td class="bg-gray-100 dark:bg-gray-500 text-center">SUB TOTAL (INCL)</td>
                <td class="text-right"><?php echo e(number_format($sub_total + ($sub_total * ($vat/100)), 2)); ?></td>
            </tr>
            <tr class="text-left">
                <td class=" font-semibold bg-gray-100 dark:bg-gray-500 text-center">GRAND TOTAL</td>
                <td class=" font-semibold text-right"><?php echo e(number_format($sub_total + ($sub_total * ($vat/100)), 2)); ?></td>
            </tr>
        </tbody>
    </table>
</div>
...
<?php endif; ?>
<?php /**PATH /home/suwilanji/dev/supply-catena/resources/views/filament/resources/packages/pages/view-package.blade.php ENDPATH**/ ?>