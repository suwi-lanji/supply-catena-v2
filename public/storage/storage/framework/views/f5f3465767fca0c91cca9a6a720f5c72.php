...
<?php $component->withAttributes([]); ?>
    ...
    <div class="p-8">
        ...
        <div class="flex justify-between mb-12">
            ...
            <div class="text-left">
                <h5 class="font-semibold text-xl text-center">SALES ORDER</h5>
    ...
    <?php echo e($record->expected_shippment_date != null ? date('Y/m/d', strtotime($record->expected_shippment_date)) : ''); ?>
        ...
        <div class="mb-12">
            ...
            <!-- SALES ORDER Number and Totals -->
            <!-- SALES ORDER Number and Totals -->
<div class="flex justify-between items-end">
    <table class="table-auto border-collapse border border-gray-300 h-fit">
        <thead>
            <tr>
                <th class="bg-gray-100 dark:bg-gray-500 px-10">SALES ORDER NO.</th>
            </tr>
        </thead>
        <tbody>
            <tr>
...
<?php endif; ?>
<?php /**PATH /home/suwilanji/dev/supply-catena/resources/views/filament/resources/sales-orders/pages/view-sales-order.blade.php ENDPATH**/ ?>