...
<?php $component->withAttributes([]); ?>
    ...
    <?php echo e(date("Y/m/d", strtotime($record->quotation_date))); ?> -
...
<div class="flex justify-between items-end">
    <table class="table-auto border-collapse border border-gray-300 h-fit">
        <thead>
            <tr>
                <th class="bg-gray-100 dark:bg-gray-500 px-10">QUOTATION NO.</th>
            </tr>
        </thead>
        <tbody>
            <tr>
                <td class="text-center"><?php echo e($record->quotation_number); ?></td>
            </tr>
        </tbody>
    </table>
...
<?php endif; ?>
<?php /**PATH /home/suwilanji/dev/supply-catena/resources/views/filament/resources/quotations/view-quotation.blade.php ENDPATH**/ ?>