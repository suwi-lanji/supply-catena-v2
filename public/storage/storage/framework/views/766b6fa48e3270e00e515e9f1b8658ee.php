...
<?php
$vendor = \App\Models\Vendor::where('id', $this->record->vendor_id)->first();
...
<style>
    ...
    <div class="invoice-tables clearfix">
        ...
        <table class="invoice-table right">
            ...
            <tbody>
                <tr>
                    ...
                    <td><?php echo e($record->credit_note_number); ?></td>
                </tr>
                <tr>
                    <td>Credit Note Date</td>
                    <td><?php echo e($record->vendor_credit_date); ?></td>
                </tr>
            </tbody>
        </table>
    </div>
        ...
        <div class="total" style="display:flex;flex-direction:column;align-items:flex-end">
            <p>Sub Total: ZMW<?php echo e($this->record->sub_total); ?></p>
            <p>Total: ZMW<?php echo e($this->record->total); ?></p>
        </div>
    </div>
...
<?php endif; ?><?php /**PATH /home/suwilanji/dev/supply-catena/resources/views/filament/resources/vendor-credits/pages/view-vendor-credits.blade.php ENDPATH**/ ?>