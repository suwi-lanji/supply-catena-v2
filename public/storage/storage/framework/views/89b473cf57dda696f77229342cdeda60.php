...
<table class="table-auto border-collapse divide-y border border-gray-300 h-fit">
        ...
        <tbody>
            <tr class="divide-x">
                <td class="text-center"><?php echo e($record->sales_receipt_number); ?></td>
                <td class="text-center"><?php echo e($record->sales_receipt_date); ?></td>
            </tr>
        </tbody>
    </table>
...
<?php endif; ?>
<?php /**PATH /home/suwilanji/dev/supply-catena/resources/views/filament/resources/sales-receipt/view-sales-receipt.blade.php ENDPATH**/ ?>