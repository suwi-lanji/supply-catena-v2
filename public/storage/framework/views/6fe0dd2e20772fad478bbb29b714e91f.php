...
<div class="invoice">
    <div class="invoice-header clearfix">
        ...
        <div class="" style="text-align: center;">
            <h5 style="margin: 0px; padding: 0px"><?php echo e($tenant->portal_name); ?></h5>
            <address style="border-top: solid 1px black;margin-top: 8px; padding-top: 8px">
                <span><b><?php echo e($tenant->city); ?>: </b> <?php echo e($tenant->street_1); ?>, <?php echo e($tenant->city); ?> - <?php echo e($tenant->business_location); ?></span><br/>
            </address>
        </div>
    </div>
...
<?php /**PATH /home/suwilanji/dev/sc-display/resources/views/pdf-andrich-purchase-order.blade.php ENDPATH**/ ?>