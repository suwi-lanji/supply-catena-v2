    ...
    <div class="invoice-tables clearfix">
        ...
        <table class="invoice-table right">
            <thead class="table-dark">
                <tr>
                    <td colspan="2" class="text-center">Receipt</td>
                </tr>
            </thead>
            <tbody>
                <tr>
                    <td>Receipt No.</td>
                    <td><?php echo e($record->sales_receipt_number); ?></td>
                </tr>
                <tr>
                    <td>Receipt Date</td>
                    <td><?php echo e($record->receipt_date); ?></td>
                </tr>
            </tbody>
        </table>
    </div>
...
<?php endif; ?>
<?php /**PATH /home/suwilanji/dev/supply-catena/resources/views/filament/resources/sales-receipt/view-sales-receipt-1.blade.php ENDPATH**/ ?>