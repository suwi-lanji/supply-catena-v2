    ...
    <table style="width: 100%; border-collapse: collapse;">
        <thead>
            <tr style="background-color: darkgray; color: #fff;">
                ...
                <th style="padding: 5px; text-align: left;">Delivered Quantity</th>
        ...
        <tbody>
            ...
            <?php
                            $order = \App\Models\SalesOrder::where("id", $item["sales_order_id"])->first();
                        ?>
                <tr style="border-bottom: 1px solid #ccc;">
                    ...
                    ?></td>
                    <td>
                        <?php echo e($order->sales_order_number); ?>
                    ...
                    <td style="padding: 5px;">
                        <?php
                            $package = \App\Models\Packages::where('id', $item["package_id"])->first();
                        ?>
...
<?php endif; ?>
<?php /**PATH /home/suwilanji/dev/sc-display/resources/views/pdf-sales-backorder.blade.php ENDPATH**/ ?>