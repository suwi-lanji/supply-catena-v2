...
<div class="invoice">
    ...
    <div class="invoice-body">
        <table class="table table-sm table-centered table-hover table-borderless mb-0 mt-3">
            ...
            <tbody>
                <?php $__currentLoopData = $record->packages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $package): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php
                    $package = \App\Models\Packages::find($package)
                ?>
                <?php $__currentLoopData = $package->items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                    <td><?php
...
</div>  <?php /**PATH /home/suwilanji/dev/supply-catena/resources/views/pdf-shipment.blade.php ENDPATH**/ ?>