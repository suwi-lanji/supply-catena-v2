...
<?php $component->withAttributes([]); ?>
    ...
    <div class="invoice-header clearfix">
        ...
        <div class="">
            ...
            <p>Billed To: <?php
                echo \App\Models\Customer::where('id', $this->record->customer_id)->pluck('company_display_name')->first();
            ?></p>
            ...
            <p>Amount: <?php echo e($tenant->currency_symbol); ?><?php echo e($this->record->amount_received); ?></p>
        </div>
        <div>
...
<?php endif; ?><?php /**PATH /home/suwilanji/dev/supply-catena/resources/views/filament/resources/payments-received/pages/view-payments-received.blade.php ENDPATH**/ ?>