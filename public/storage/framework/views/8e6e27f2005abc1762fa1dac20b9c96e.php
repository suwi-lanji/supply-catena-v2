...
<?php $component->withAttributes([]); ?>
    ...
    <div class="">
        ...
        <div class="document" style="border:solid 1px;padding:10px">
        <?php
    ...
    <div class="invoice-tables clearfix">
        ...
        <table class="invoice-table right">
            ...
            <tbody>
                <tr>
                    <td>Shipment No.</td>
                    <td><?php echo e($record->shipment_order_number); ?></td>
                </tr>
                <tr>
                    <td>Order Date</td>
        ...
        <div style="width: 100%;margin-top:20px">
            ...
            <tr style="background-color: darkgray; color: #fff;">
                ...
                <tbody>
                    ...
                    ?>
                    <tr>
                        <td style="padding: 5px;"><?php echo e($purchase_order->purchase_order_number); ?></td>
                        <td style="padding: 5px;"><?php echo e($purchase_order->purchase_order_date); ?></td>
                        <td style="padding: 5px;"><?php echo e($purchase_order->reference_number); ?></td>
                        <td style="padding: 5px;"><?php echo e($purchase_order->total); ?></td>
                        <td style="padding: 5px;"><?php echo e($purchase_order->expected_delivery_date); ?></td>
                    </tr>
                </tbody>
...
<?php endif; ?><?php /**PATH /home/suwilanji/dev/supply-catena/resources/views/filament/resources/shipments/pages/view-purchase-order-shipment.blade.php ENDPATH**/ ?>