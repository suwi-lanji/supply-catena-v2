    ...
    <div class="invoice-tables clearfix">
        ...
        <table class="invoice-table right">
            <thead class="table-dark">
                <tr>
                    <td colspan="2" class="text-center">Credit Note</td>
                </tr>
            </thead>
            <tbody>
                <tr>
                ...
                <tr>
                    <td>Credit Date</td>
                    <td><?php echo e($record->credit_note_date); ?></td>
                </tr>
                <tr>
...
<?php endif; ?>
<?php /**PATH /home/suwilanji/dev/supply-catena/resources/views/filament/resources/credit-notes/pages/view-credit-notes.blade.php ENDPATH**/ ?>