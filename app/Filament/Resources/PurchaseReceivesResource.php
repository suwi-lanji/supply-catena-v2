...
use App\Filament\Resources\PurchaseReceivesResource\RelationManagers;
                        ...
                        Forms\Components\Select::make('purchase_order_number')
                            ...
                            ->afterStateUpdated(function(Forms\Components\Select $component, string $state, $get, $set) {
                                ...
                                foreach($items[0] as $item) {
                                    $i = array('item'=>$item['item'], 'ordered'=>$item['quantity'], 'received'=>0, 'in_transit'=>0, 'quantity_to_receive'=>$item['quantity']);
                                    array_push($parsed, $i);
                                }
                                $set('items', $parsed);
                            })
