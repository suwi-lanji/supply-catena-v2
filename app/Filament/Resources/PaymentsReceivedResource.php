...
use App\Filament\Resources\PaymentsReceivedResource\RelationManagers;
                ...
                ->schema([
                    ...
                    ->afterStateHydrated(function (Request $request, $get, $set) {
                        if($request->input('invoice_id')) {
                            ...
                            $item = array('invoice_id'=>$invoice['id'],'date' =>$invoice['invoice_date'],'invoice_number' =>$invoice['invoice_number'],'purchase_order_number' => $invoice['order_number'],'invoice_amount' => $invoice['total'],'amount_due' => $invoice['balance_due'],'payment' => 0);
