...
class SalesOrderSummary extends ChartWidget
{
    protected static ?string $heading = 'Sales Order Summary';
    ...
    protected function getData(): array
    {
        $filter = $this->filter;
        if ($filter == 'year') {
            $data = Trend::query(SalesOrder::where('team_id', Filament::getTenant()->id))
                ->between(
