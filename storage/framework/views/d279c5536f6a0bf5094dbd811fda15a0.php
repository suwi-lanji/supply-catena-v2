        ...
        <!--[if BLOCK]><![endif]--><?php if(count($containers)): ?>
            ...
            >
                ...
                <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $containers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $uuid => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    >
                        <!--[if BLOCK]><![endif]--><?php if($reorderActionIsVisible || $moveUpActionIsVisible || $moveDownActionIsVisible || $hasBlockLabels || $cloneActionIsVisible || $deleteActionIsVisible || $isCollapsible || $visibleExtraItemActions): ?>
                            <div
...
<?php endif; ?>
<?php /**PATH /var/www/html/vendor/filament/forms/src/../resources/views/components/builder.blade.php ENDPATH**/ ?>