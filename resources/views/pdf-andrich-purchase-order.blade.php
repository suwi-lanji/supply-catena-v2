...
<div class="invoice">
    <div class="invoice-header clearfix">
        ...
        <div class="" style="text-align: center;">
            <h5 style="margin: 0px; padding: 0px">{{ $tenant->portal_name }}</h5>
            <address style="border-top: solid 1px black;margin-top: 8px; padding-top: 8px">
                <span><b>{{ $tenant->city }}: </b> {{ $tenant->street_1 }}, {{ $tenant->city }} - {{ $tenant->business_location }}</span><br/>
            </address>
        </div>
    </div>
    ...
    <div class="invoice-tables clearfix">
        ...
        <table class="invoice-table right">
            ...
            <tbody>
                ...
                <tr>
                    <td>Order Date</td>
                    <td>{{$record->purchase_order_date}}</td>
                </tr>
            </tbody>
        </table>
    </div>
    ...
    <div class="invoice-body">
        <table class="table table-sm table-centered table-hover table-borderless mb-0 mt-3">
            ...
            @foreach ($record->items as $item)
                ...
                @endphp
                <tr>
                    <td style="">{{ $itemDetails->name }}</td>
                    <td style="">{{ $item['quantity'] }}</td>
                    <td style="">{{ $item['rate'] }}</td>
